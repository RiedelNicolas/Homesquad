    ...
    <Card>
      <Card.Content style={styles.card}>
        ...
        <Text variant="bodyMedium">
          ¡Hola! Soy Juan, un gasista matriculado con más de 10 años de experiencia. 
          Estoy aquí para ofrecerte servicios de instalación, mantenimiento y reparación de gas. 
          Mi objetivo es brindarte soluciones seguras y eficientes. Confía en mí para mantener tu 
          hogar o negocio en perfectas condiciones.
        </Text>
      </Card.Content>
    </Card>
  );
  ...
  <View >
    ...
    <Card style={styles.rating}>
      <Card.Title
        ...
        left={(props) => <Avatar.Image size={50} source={require('../assets/ana.jpeg')} />}
        right={(props) => <Rating imageSize={30} readonly startingValue={5}/>}
      />
      <Card.Content>
        <Text variant="bodyMedium">
          Juan es un gasista excepcional. Tenía un problema con una fuga de gas en mi hogar,
           pero Juan lo resolvió rápidamente y de manera segura. Su profesionalismo y habilidad
            son impresionantes. Recomendado al 100%.
        </Text>
      </Card.Content>
    </Card>
  </View>
